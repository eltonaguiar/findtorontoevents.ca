        ...
        <div class="jsx-1b9a23bd3fa6c640 favcreators-promo" style="display: block !important; visibility: visible !important;">
          <div class="jsx-1b9a23bd3fa6c640 promo-banner" style="display: block !important; visibility: visible !important;">
            <div class="jsx-1b9a23bd3fa6c640 flex items-center gap-3 transition-all duration-500 opacity-60 grayscale hover:opacity-100 hover:grayscale-0 group" style="display: flex !important; visibility: visible !important;">
              ...
              <div class="jsx-1b9a23bd3fa6c640 transition-all duration-500 max-w-0 opacity-0 overflow-hidden group-hover:max-w-xs group-hover:opacity-100" style="max-width: 0;">
              ...
              <div class="jsx-1b9a23bd3fa6c640 relative">
                ...
                <div class="jsx-1b9a23bd3fa6c640 absolute top-full left-0 mt-2 w-64 p-3 bg-[var(--surface-1)] border border-white/10 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50" style="left: auto; right: 0;">
                  <p class="text-xs text-[var(--text-2)] mb-2">Ever wish you could find one of your favorite creators, or track your creators latest stories/live stream status across multiple platforms? Track TikTok, Twitch, Kick & YouTube in one place so they don't get lost in your feed!</p>
