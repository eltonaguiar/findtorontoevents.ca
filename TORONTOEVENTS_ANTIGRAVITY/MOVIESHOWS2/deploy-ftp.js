...
async function deploy() {
    ...
    try {
        ...
        // IMPORTANT: Path is /findtorontoevents.ca/MOVIESHOWS2 (uppercase MOVIESHOWS2)
        ...
        console.log('🗄️  Initialize DB: https://findtorontoevents.ca/MOVIESHOWS2/init-database.php\n');
